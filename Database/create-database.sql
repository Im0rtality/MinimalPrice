...
-- -----------------------------------------------------
-- Table `minimalprice`.`cimage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`cimage` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`cimage` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`category` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `cimage_id` INT UNSIGNED NOT NULL ,
  `name` VARCHAR(45) NOT NULL ,
  `parent_id` INT NULL ,
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `category_UNIQUE` (`name` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_category_cimage1` (`cimage_id` ASC) ,
  CONSTRAINT `fk_category_cimage1`
    FOREIGN KEY (`cimage_id` )
    REFERENCES `minimalprice`.`cimage` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `minimalprice`.`gpuchip`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`gpuchip` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`gpuchip` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `manufacturer_id` INT UNSIGNED NOT NULL ,
...
-- -----------------------------------------------------
-- Table `minimalprice`.`socket`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`socket` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`socket` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`motherboard` (
  ...
  INDEX `fk_motherboard_socket1` (`socket_id` ASC) ,
  ...
  CONSTRAINT `motherboards_ibfk_7`
    ...
    REFERENCES `minimalprice`.`gpuchip` (`id` )
    ON UPDATE CASCADE,
  ...
  CONSTRAINT `fk_motherboard_product1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_motherboard_socket1`
    FOREIGN KEY (`socket_id` )
    REFERENCES `minimalprice`.`socket` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 3
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`cpu` (
  ...
  `cache_l3_kb` INT NULL ,
  `turbo_frequency_mhz` INT NULL ,
  `threads` INT NOT NULL ,
  `power_consumption_w` DECIMAL(3) NULL ,
  `launch_date` DATETIME NULL ,
  `bus_core_ratio` INT NULL ,
  `bus_speed_mhz` INT NULL ,
  `max_tdp` INT NULL ,
  `max_ram_mb` INT NULL ,
  `ram_channels` INT NULL ,
  `ram_bandwidth` INT NULL ,
  `max_cpus_configuration` INT NULL ,
  `technology_nm` INT NULL ,
...
-- -----------------------------------------------------
-- Table `minimalprice`.`privilege`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`privilege` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`privilege` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`user` (
  ...
  INDEX `fk_user_privilege1` (`privilege_id` ASC) ,
  ...
  CONSTRAINT `fk_user_privilege1`
    ...
    REFERENCES `minimalprice`.`privilege` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `minimalprice`.`parser`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`parser` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`parser` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `name` VARCHAR(45) NOT NULL ,
  `value` TEXT NOT NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`shop` (
  ...
  INDEX `fk_shop_parser1` (`parser_id` ASC) ,
  CONSTRAINT `fk_shops_countries1`
    FOREIGN KEY (`country_id` )
    REFERENCES `minimalprice`.`country` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_shop_parser1`
    FOREIGN KEY (`parser_id` )
    REFERENCES `minimalprice`.`parser` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `minimalprice`.`pimage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`pimage` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`pimage` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `url` VARCHAR(200) NOT NULL ,
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
...
-- -----------------------------------------------------
-- Table `minimalprice`.`cpu_technology`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`cpu_technology` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`cpu_technology` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `cpu_id` INT UNSIGNED NOT NULL ,
  `technology_id` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`id`, `cpu_id`, `technology_id`) ,
  INDEX `fk_cpu_has_technology_technology1` (`technology_id` ASC) ,
  INDEX `fk_cpu_has_technology_cpu1` (`cpu_id` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  CONSTRAINT `fk_cpu_has_technology_cpu1`
    FOREIGN KEY (`cpu_id` )
    REFERENCES `minimalprice`.`cpu` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cpu_has_technology_technology1`
    FOREIGN KEY (`technology_id` )
    REFERENCES `minimalprice`.`technology` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `minimalprice`.`pimage_product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`pimage_product` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`pimage_product` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `pimage_id` INT UNSIGNED NOT NULL ,
  `product_id` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`id`, `pimage_id`, `product_id`) ,
  INDEX `fk_pimage_has_product_product1` (`product_id` ASC) ,
  INDEX `fk_pimage_has_product_pimage1` (`pimage_id` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  UNIQUE INDEX `pimage_id_UNIQUE` (`pimage_id` ASC) ,
  CONSTRAINT `fk_pimage_has_product_pimage1`
    FOREIGN KEY (`pimage_id` )
    REFERENCES `minimalprice`.`pimage` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pimage_has_product_product1`
    FOREIGN KEY (`product_id` )
    REFERENCES `minimalprice`.`product` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `minimalprice`.`merchandise`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`merchandise` ;
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`merchandise` (
  ...
  `warranty_mm` INT NULL ,
  `url` VARCHAR(200) NULL ,
  PRIMARY KEY (`id`) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  INDEX `fk_merchandise_currency1` (`currency_id` ASC) ,
  INDEX `fk_merchandise_product1` (`product_id` ASC) ,
  INDEX `fk_merchandise_shop1` (`shop_id` ASC) ,
  CONSTRAINT `fk_merchandise_currency1`
    FOREIGN KEY (`currency_id` )
    REFERENCES `minimalprice`.`currency` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_merchandise_product1`
    FOREIGN KEY (`product_id` )
    REFERENCES `minimalprice`.`product` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_merchandise_shop1`
    FOREIGN KEY (`shop_id` )
...
-- -----------------------------------------------------
-- Table `minimalprice`.`accessory_product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `minimalprice`.`accessory_product` ;

CREATE  TABLE IF NOT EXISTS `minimalprice`.`accessory_product` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
  `accessory_id` INT UNSIGNED NOT NULL ,
  `product_id` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`id`, `accessory_id`, `product_id`) ,
  INDEX `fk_accessory_product_product1` (`product_id` ASC) ,
  INDEX `fk_accessory_product_accessory1` (`accessory_id` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  CONSTRAINT `fk_accessory_product_accessory1`
    FOREIGN KEY (`accessory_id` )
    REFERENCES `minimalprice`.`accessory` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_accessory_product_product1`
    FOREIGN KEY (`product_id` )
    REFERENCES `minimalprice`.`product` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE  TABLE IF NOT EXISTS `minimalprice`.`cpu_socket` (
  ...
  `cpu_id` INT UNSIGNED NOT NULL ,
  `socket_id` INT UNSIGNED NOT NULL ,
  PRIMARY KEY (`id`, `cpu_id`, `socket_id`) ,
  INDEX `fk_cpu_socket_socket1` (`socket_id` ASC) ,
  INDEX `fk_cpu_socket_cpu1` (`cpu_id` ASC) ,
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  CONSTRAINT `fk_cpu_socket_cpu1`
    FOREIGN KEY (`cpu_id` )
    REFERENCES `minimalprice`.`cpu` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cpu_socket_socket1`
    FOREIGN KEY (`socket_id` )
    REFERENCES `minimalprice`.`socket` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
